        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              // If not authenticated, show original utility links
        ...
        <div className="md:hidden absolute top-full left-0 w-full bg-gray-900 dark:bg-gray-900 border-t border-gray-800 dark:border-gray-800 shadow-lg py-4 px-4">
          ...
          <nav className="flex flex-col space-y-3 mb-4">
            ...
            {isAuthenticated ? (
              ...
              <button onClick={handleLogout} className="block text-base font-medium text-gray-300 hover:text-white transition-colors mt-3" onClick={handleMobileLinkClick}>
                Log out
              </button>
            ) : (
