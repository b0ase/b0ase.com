  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800 text-black dark:text-white py-4 shadow-sm px-6">
      <div className="flex items-center justify-between">
        {/* Left-aligned group: Logo, Studio Link, Main Nav */}
        <div className="flex items-center flex-grow">
          ...
          {/* Studio link - always visible on desktop, to the right of the logo */}
          <Link href="/studio" className="text-sm font-medium text-gray-300 hover:text-white transition-colors ml-4 hidden md:flex">
            /studio
          </Link>
        ...
        {/* Right-aligned group: Utility Links, Social Icons, Theme Toggle, Admin, Mobile Button */}
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-gray-900 dark:bg-gray-900 border-t border-gray-800 dark:border-gray-800 shadow-lg py-4 px-4">
          ...
          <nav className="flex flex-col space-y-3 mb-4">
             {/* Studio link - always visible, to the right of the logo */}
