  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800 text-black dark:text-white py-4 shadow-sm px-6">
      <div className="flex items-center justify-between">
        ...
        {/* Desktop Navigation Links and Studio Link */}
        <nav className="hidden md:flex items-center space-x-6 ml-6">
          {/* Studio link - always visible on desktop, to the right of the logo */}
          <Link key="desktop-studio-link" href="/studio" className="text-sm font-medium text-gray-300 hover:text-white transition-colors">
            /studio
          </Link>
