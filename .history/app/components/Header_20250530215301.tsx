...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-background border-b border-border text-foreground py-4 shadow-sm px-6">
      <div className="flex items-center justify-between">
        {/* Logo - Ensure white/light text in dark mode */}
        <Link 
          href="/" 
          className="text-xl text-foreground hover:text-muted-foreground transition-colors font-mono flex items-center gap-2"
