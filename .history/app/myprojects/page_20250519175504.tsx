  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-2 mb-4" onClick={(e) => e.stopPropagation()}>
        {project.badge1 && <span className={getMutedBadgeStyle(project.badge1, 'status')}>{project.badge1}</span>}
        {project.badge2 && <span className={getMutedBadgeStyle(project.badge2, 'category')}>{project.badge2}</span>}
        {project.badge3 && <span className={getMutedBadgeStyle(project.badge3, 'priority')}>{project.badge3}</span>}
